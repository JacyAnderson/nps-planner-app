...
},
{
  ...
  "description": "The Hampton estate was created and evolved through the actions of enslaved African Americans, European indentured servants and the Ridgely family within a nation struggling to define its own concept of freedom.",
  "designation": "National Historic Site",
  "parkCode": "hamp",
...
},
{
  ...
  "latLong": "",
  "description": "",
  "designation": "parque historical nacional",
  "parkCode": "es-es/lewi",
  "id": "1F7DF661-054A-4BCB-81AE-82690159B01D",
  "directionsInfo": "",
  "directionsUrl": "",
  "fullName": "Lewis y Clark parque historical nacional",
  "url": "",
  "weatherInfo": "",
  "name": "Lewis y Clark"
},
...
},
{
  ...
  "directionsInfo": "The heritage area is located along the Mississippi gulf coast. Interstate I-10 runs east and west while I-59 cuts across the northwest corner of the NHA. The Gulfport-Biloxi International Airport allows visitors to fly directly into Mississippi Gulf NHA as well.",
  "directionsUrl": "http://msgulfcoastheritage.ms.gov/page/NHA-Map",
...
},
{
  ...
  db.Park.remove({}, function(err, parks) {
    ...
    // Creates national parks in database
    db.Park.create(nationalParks, function(err, parks) {
      if (err) {return console.log('Error', err); }
      console.log("created ", parks.length, "parks");
      process.exit();
    });
  });